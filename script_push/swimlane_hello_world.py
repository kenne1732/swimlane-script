...
# base_url = os.getenv("https://soar-prod.bluebastion.local/api")
...
# response = requests.post(url="https://soar-prod.bluebastion.local/api", headers=headers, json=script_data, verify=False)
...
# base_url = os.getenv(soar-prod.bluebastion.local/api")
# url = f"{base_url}v1/scripts"
